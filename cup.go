...
func init() {
	...
	trigger := &nlp.StructuredInput{
		...
		Objects:  []string{"coupon", "discount"},
	}
	...
	var err error
	p, err = plugin.New("github.com/chajas/plugin_cup", trigger, fns)
	if err != nil {
		...
		[]dt.State{
			{
				OnEntry: func(in *dt.Msg) string {
					return "Looking for an interesting deal? Search for a coupon here!"
				},
